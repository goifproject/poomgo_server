...
function addMemberToStudy(param_study_id, param_member_id, callback) {
...
function getMemberList(param_study_id, callback) {
    // TODO 권한 설정!
...
function removeMemberFromStudy(param_member_id, callback) {
